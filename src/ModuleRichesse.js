...
// ✅ Compteur Astaghfirullah + Clés Richesse (Coran/Sunnah)
// ✅ Tasbih digital (6 dhikr) + Dou'as par catégorie
// ✅ Calendrier islamique sacré + Journal gratitude/intention
// ✅ Affirmations quotidiennes IA
// ============================================================
...
function canUseAI(isPrem) {
  if (isPrem) return true;
  try {
    const d = JSON.parse(localStorage.getItem("vs_usage_affirmations_ia") || "{}");
...
function incrementAI() {
  try {
    const k = "vs_usage_affirmations_ia";
...
const DOUAS = {
  sante: {
    label: "Santé & Guérison", emoji: "🌿", color: "#00ff88",
    items: [
      { titre: "Dou'a de la maladie", arabe: "اللَّهُمَّ رَبَّ النَّاسِ أَذْهِبِ الْبَأْسَ اشْفِهِ وَأَنْتَ الشَّافِي", phonetique: "Allahumma Rabb an-nas, adhhibil ba's, ishfihi wa anta ash-Shafi", traduction: "Ô Allah, Seigneur des hommes, enlève la souffrance, guéris-le/la, Tu es le Guérisseur.", source: "Bukhari & Muslim" },
      { titre: "Protection le matin", arabe: "بِسْمِ اللَّهِ الَّذِي لَا يَضُرُّ مَعَ اسْمِهِ شَيْءٌ فِي الْأَرْضِ وَلَا فِي السَّمَاءِ", phonetique: "Bismillahil-ladhi la yadurru ma'asmihi shay'un fil-ardi wala fis-sama'i", traduction: "Au nom d'Allah, avec Son Nom, rien ne peut nuire ni sur terre ni dans le ciel.", source: "Abu Dawud · 3 fois le matin" },
      { titre: "Ruqya personnelle", arabe: "أَعُوذُ بِكَلِمَاتِ اللَّهِ التَّامَّاتِ مِنْ شَرِّ مَا خَلَقَ", phonetique: "A'udhu bikalimatil-lahit-tammati min sharri ma khalaq", traduction: "Je cherche refuge dans les paroles parfaites d'Allah contre le mal de ce qu'Il a créé.", source: "Muslim · 3 fois le soir" },
    ],
  },
  confiance: {
    label: "Confiance & Force", emoji: "⚡", color: "#fbbf24",
    items: [
      { titre: "Dou'a de l'anxiété", arabe: "اللَّهُمَّ إِنِّي أَعُوذُ بِكَ مِنَ الْهَمِّ وَالْحَزَنِ", phonetique: "Allahumma inni a'udhu bika minal-hammi wal-hazan", traduction: "Ô Allah, je cherche refuge en Toi contre l'anxiété et la tristesse.", source: "Bukhari" },
      { titre: "Dou'a de Yunus ﷺ", arabe: "لَا إِلَهَ إِلَّا أَنتَ سُبْحَانَكَ إِنِّي كُنتُ مِنَ الظَّالِمِينَ", phonetique: "La ilaha illa Anta subhanaka inni kuntu minaz-zalimin", traduction: "Il n'y a de dieu que Toi, gloire à Toi, j'ai été vraiment du nombre des injustes.", source: "Coran 21:87 · Dou'a de détresse" },
      { titre: "Hasbunallah", arabe: "حَسْبُنَا اللَّهُ وَنِعْمَ الْوَكِيلُ", phonetique: "Hasbunallahu wa ni'mal wakil", traduction: "Allah nous suffit, Il est le meilleur des garants.", source: "Coran 3:173 · Dou'a d'Ibrahim ﷺ dans le feu" },
    ],
  },
  gratitude: {
    label: "Gratitude & Sabr", emoji: "🙏", color: "#e2b84a",
    items: [
      { titre: "Alhamdulillah complet", arabe: "الْحَمْدُ لِلَّهِ الَّذِي بِنِعْمَتِهِ تَتِمُّ الصَّالِحَاتُ", phonetique: "Alhamdulillahil-ladhi bini'matihi tatimmus-salihat", traduction: "Louange à Allah par qui les bonnes choses s'accomplissent.", source: "Ibn Majah" },
      { titre: "Dou'a du matin — gratitude", arabe: "اللَّهُمَّ مَا أَصْبَحَ بِي مِنْ نِعْمَةٍ فَمِنْكَ وَحْدَكَ", phonetique: "Allahumma ma asbaha bi min ni'matin fa minka wahdak", traduction: "Ô Allah, tout bienfait que je reçois ce matin ne vient que de Toi seul.", source: "Abu Dawud · Chaque matin" },
      { titre: "Patience et récompense", arabe: "إِنَّا لِلَّهِ وَإِنَّا إِلَيْهِ رَاجِعُونَ", phonetique: "Inna lillahi wa inna ilayhi raji'un", traduction: "Nous appartenons à Allah et c'est vers Lui que nous retournons.", source: "Coran 2:156 · En cas d'épreuve" },
    ],
  },
  protection: {
    label: "Protection & Famille", emoji: "🛡️", color: "#60a5fa",
    items: [
      { titre: "Ayat al-Kursi", arabe: "اللَّهُ لَا إِلَهَ إِلَّا هُوَ الْحَيُّ الْقَيُّومُ", phonetique: "Allahu la ilaha illa huwal-hayyul-qayyum...", traduction: "Allah, il n'y a de dieu que Lui, le Vivant, Celui qui subsiste par Lui-même.", source: "Coran 2:255 · La plus grande protection" },
      { titre: "Protection de la famille", arabe: "أَعُوذُ بِكَلِمَاتِ اللَّهِ التَّامَّةِ مِنْ كُلِّ شَيْطَانٍ وَهَامَّةٍ", phonetique: "A'udhu bikalimatil-lahit-tammati min kulli shaytanin wa hammah", traduction: "Je cherche refuge dans les paroles parfaites d'Allah contre tout démon et toute bête nuisible.", source: "Bukhari · Pour les enfants" },
      { titre: "Dou'a pour les parents", arabe: "رَّبِّ ارْحَمْهُمَا كَمَا رَبَّيَانِي صَغِيرًا", phonetique: "Rabbi irhamhuma kama rabbayani saghira", traduction: "Seigneur, fais-leur miséricorde comme ils m'ont élevé tout petit.", source: "Coran 17:24" },
    ],
  },
  grossesse: {
    label: "Grossesse & Bébé", emoji: "🤰", color: "#f9a8d4",
    items: [
      { titre: "Dou'a pour l'enfant à naître", arabe: "رَبِّ هَبْ لِي مِن لَّدُنكَ ذُرِّيَّةً طَيِّبَةً", phonetique: "Rabbi hab li min ladunka dhurriyyatan tayyibah", traduction: "Seigneur, accorde-moi de Ta part une descendance vertueuse.", source: "Coran 3:38 · Dou'a de Zakariya ﷺ" },
      { titre: "Protection du bébé", arabe: "أُعِيذُهَا بِكَ وَذُرِّيَّتَهَا مِنَ الشَّيْطَانِ الرَّجِيمِ", phonetique: "U'idhuhuma bika wa dhurriyyataha minash-shaytanir-rajim", traduction: "Je les confie à Ta protection contre Satan le maudit.", source: "Coran 3:36 · Dou'a de Maryam ﷺ" },
      { titre: "Dou'a pour un accouchement facile", arabe: "لَا إِلَهَ إِلَّا أَنتَ سُبْحَانَكَ إِنِّي كُنتُ مِنَ الظَّالِمِينَ", phonetique: "La ilaha illa Anta subhanaka inni kuntu minaz-zalimin", traduction: "Dou'a de Yunus ﷺ — pour chaque difficulté. Répète 40x.", source: "Coran 21:87" },
    ],
  },
};
  ...
  return (
    <div style={{ background: CARD, border: `1.5px solid ${PURPLE}33`, borderRadius: 20, padding: 20, marginBottom: 16 }}>
      ...
      <div style={{ display: "flex", justifyContent: "center", marginBottom: 18 }}>
        <button onClick={tap} style={{ width: 180, height: 180, borderRadius: "50%", background: `conic-gradient(${PURPLE} ${pct}%, #1a1025 ${pct}%)`, border: "none", cursor: "pointer", position: "relative", transform: pulse ? "scale(0.96)" : "scale(1)", transition: "transform .12s ease", padding: 8 }}>
          <div style={{ width: "100%", height: "100%", borderRadius: "50%", background: "#0a0612", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
      ...
      {todayCount > 0 && (
        <button onClick={reset} style={{ width: "100%", background: "transparent", border: `1px solid ${BDR}`, borderRadius: 10, padding: "8px", fontFamily: "'Outfit',sans-serif", fontSize: 11, color: MUT, cursor: "pointer" }}>
...
function ProgressionChart({ lang }) {
  const L = lang === "en";
  const data = loadData();
  const days = Object.entries(data).sort((a, b) => a[0].localeCompare(b[0])).slice(-14);
        ...
        {days.map(([date, d], i) => {
          ...
          return (
            <div key={i} style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", gap: 3 }}>
              ...
              <div style={{ width: "100%", height: `${h}px`, background: isToday ? PURPLE : `${PURPLE}66`, borderRadius: "3px 3px 0 0" }} />
...
// ============================================================
// COMPOSANT PRINCIPAL — FUSION
// ============================================================
export default function ModuleRichesse({ user, profile, onBack, onCoinsEarned, lang }) {
  const L = lang === "en";
  ...
  // tab: compteur | cles | accueil | islamique | douas | tasbih | journal
  const [tab, setTab]                   = useState("compteur");
  ...
  const streak = (() => {
    let s = 0, d = new Date();
    for (let i = 0; i < 60; i++) {
      if (entries.find((e) => e.date === d.toISOString().slice(0, 10))) { s++; d.setDate(d.getDate() - 1); }
      else break;
    }
    return s;
  })();
  ...
  const TABS = [
    { id: "compteur",  emoji: "🤲", label: L ? "Wealth" : "Richesse" },
    { id: "cles",      emoji: "🔑", label: L ? "Keys" : "Clés" },
    { id: "tasbih",    emoji: "📿", label: L ? "Dhikr" : "Dhikr" },
    { id: "journal",   emoji: "📝", label: L ? "Journal" : "Journal" },
    { id: "accueil",   emoji: "✨", label: L ? "Affirmations" : "Affirmations" },
    { id: "islamique", emoji: "🌙", label: L ? "Islam" : "Islam" },
    { id: "douas",     emoji: "🤲", label: L ? "Duas" : "Dou'as" },
  ];
  ...
  return (
    <div style={{ minHeight: "100vh", paddingBottom: 100, overflowY: "auto", background: "#060d08" }}>
      ...
      <div style={{ padding: "52px 20px 16px", background: `radial-gradient(ellipse at 50% 0%,${P.color}15 0%,#060d08 65%)` }}>
        <button onClick={onBack} style={{ background: "none", border: "none", color: MUT, cursor: "pointer", fontSize: 13, marginBottom: 12, display: "block" }}>
          ← {L ? "Back" : "Retour"}
        </button>

        <div style={{ textAlign: "center", marginBottom: 14 }}>
          <div style={{ fontSize: 40, marginBottom: 6 }}>🌙</div>
          <div className="serif" style={{ fontSize: 20, fontWeight: 700, color: "#edf5ef", marginBottom: 4 }}>
            {L ? "Wealth & Dhikr" : "Richesse & Dhikr"}
          </div>
          <div style={{ color: MUT, fontSize: 11, lineHeight: 1.5, maxWidth: 280, margin: "0 auto" }}>
            {L ? "Istighfar, dhikr, dou'as and trust in Allah — the keys that open doors." : "Istighfar, dhikr, dou'as et confiance en Allah — les clés qui ouvrent les portes."}
          </div>
        </div>
        ...
        {(jourSacre || isVendredi) && (
          <div style={{ background: jourSacre ? `${jourSacre.couleur}15` : "#1a0510", border: `1.5px solid ${jourSacre ? jourSacre.couleur : "#f9a8d4"}55`, borderRadius: 16, padding: "12px 14px", marginBottom: 14, cursor: "pointer" }} onClick={() => setTab("islamique")}>
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <span style={{ fontSize: 26 }}>{jourSacre ? jourSacre.emoji : "🕌"}</span>
              <div style={{ flex: 1 }}>
                <div style={{ fontWeight: 700, fontSize: 12, color: jourSacre ? jourSacre.couleur : "#f9a8d4" }}>{jourSacre ? jourSacre.nom : "Aujourd'hui c'est Vendredi 🕌"}</div>
                <div style={{ fontSize: 10, color: MUT, marginTop: 2, lineHeight: 1.4 }}>{jourSacre ? jourSacre.desc.slice(0, 70) + "..." : "Lis Sourate Al-Kahf · Fais beaucoup de Salawat"}</div>
              </div>
              <div style={{ fontSize: 10, color: jourSacre ? jourSacre.couleur : "#f9a8d4", fontWeight: 700 }}>Voir →</div>
            </div>
          </div>
        )}
        ...
        <div style={{ display: "flex", gap: 6, overflowX: "auto", paddingBottom: 2 }}>
          {TABS.map((t) => (
            <button key={t.id} onClick={() => setTab(t.id)} style={{ background: tab === t.id ? `${P.color}20` : CARD, border: `1.5px solid ${tab === t.id ? P.color : BDR}`, borderRadius: 14, padding: "8px 12px", cursor: "pointer", fontFamily: "'Outfit',sans-serif", flexShrink: 0, transition: "all .2s" }}>
          ...
          <div style={{ paddingTop: 8 }}>
            {CLES_RICHESSE.map((cle, i) => (
              <div key={i} style={{ background: CARD, border: `1px solid ${BDR}`, borderRadius: 16, padding: 16, marginBottom: 12 }}>
                ...
                <div style={{ fontSize: 13, color: "#a0c8a8", lineHeight: 1.7, fontStyle: "italic", marginBottom: 8 }}>{L ? cle.textEn : cle.textFr}</div>
            ...
            {loadingAff ? (
              ...
              <>
                ...
                <div style={{ display: "flex", gap: 10, marginBottom: 14 }}>
                  ...
                  <button onClick={() => setTab("tasbih")} style={{ flex: 1, background: "#1a1005", border: `1px solid ${GOLD}33`, borderRadius: 12, padding: 12, fontFamily: "'Outfit',sans-serif", fontSize: 13, color: GOLD, cursor: "pointer", fontWeight: 700 }}>📿 Dhikr</button>
                </div>
              </>
            )}
          </div>
              ...
              <>
                <div style={{ display: "flex", gap: 8, overflowX: "auto", paddingBottom: 8, marginBottom: 14 }}>
                  {Object.entries(DOUAS).map(([key, cat]) => (
                    <button key={key} onClick={() => setDouaTab(key)} style={{ background: douaTab === key ? `${cat.color}20` : CARD, border: `1.5px solid ${douaTab === key ? cat.color : BDR}`, borderRadius: 14, padding: "8px 12px", cursor: "pointer", fontFamily: "'Outfit',sans-serif", flexShrink: 0 }}>
                ...
                {DOUAS[douaTab]?.items.map((doua, i) => (
                  <button key={i} onClick={() => setSelectedDoua(doua)} style={{ width: "100%", background: CARD, border: `1px solid ${DOUAS[douaTab].color}22`, borderRadius: 16, padding: "14px 16px", cursor: "pointer", textAlign: "left", marginBottom: 10, fontFamily: "'Outfit',sans-serif" }}>
        ...
        {tab === "tasbih" && (
          <div style={{ paddingTop: 8 }}>
            ...
            <div style={{ display: "flex", gap: 6, overflowX: "auto", paddingBottom: 8, marginBottom: 16 }}>
              {DHIKR_LIST.map((d) => (
                <button key={d.id} onClick={() => setTasbihId(d.id)} style={{ background: tasbihId === d.id ? `${d.color}20` : CARD, border: `1.5px solid ${tasbihId === d.id ? d.color : BDR}`, borderRadius: 14, padding: "8px 10px", cursor: "pointer", fontFamily: "'Outfit',sans-serif", flexShrink: 0 }}>
            ...
            <div style={{ textAlign: "center", marginBottom: 20 }}>
              ...
              <div style={{ position: "relative", width: 180, height: 180, margin: "0 auto 20px" }}>
                <svg width="180" height="180" style={{ transform: "rotate(-90deg)" }}>
                  ...
                  <circle cx="90" cy="90" r="80" fill="none" stroke={activeTasbih.color} strokeWidth="12" strokeDasharray={`${2 * Math.PI * 80}`} strokeDashoffset={`${2 * Math.PI * 80 * (1 - prog / 100)}`} strokeLinecap="round" style={{ transition: "stroke-dashoffset .3s ease" }} />
                </svg>
                <button onClick={incrementTasbih} style={{ position: "absolute", inset: 12, borderRadius: "50%", background: vibrating ? `${activeTasbih.color}30` : `${activeTasbih.color}12`, border: `2px solid ${activeTasbih.color}44`, cursor: "pointer", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", transition: "all .1s", transform: vibrating ? "scale(0.95)" : "scale(1)" }}>
        ...
        {tab === "journal" && (
          <div style={{ paddingTop: 8 }}>
            ...
            <div style={{ background: CARD, border: `1px solid ${BDR}`, borderRadius: 16, padding: 16, marginBottom: 14 }}>
              ...
              <div style={{ display: "flex", gap: 10, justifyContent: "center" }}>
                {HUMEURS.map((e, i) => (
                  <button key={i} onClick={() => setHumeur(i + 1)} style={{ fontSize: 32, background: humeur === i + 1 ? `${P.color}20` : "transparent", border: `1.5px solid ${humeur === i + 1 ? P.color : "transparent"}`, borderRadius: 12, padding: "6px 10px", cursor: "pointer" }}>{e}</button>
                ))}
              </div>
            </div>
            ...
            <button onClick={saveJournal} style={{ width: "100%", background: saved ? `${EM}15` : "linear-gradient(135deg,#1a3300,#264d00)", border: `1.5px solid ${saved ? EM : EM + "55"}`, borderRadius: 16, padding: "16px", fontFamily: "'Outfit',sans-serif", fontSize: 15, fontWeight: 700, color: EM, cursor: "pointer", transition: "all .3s" }}>
